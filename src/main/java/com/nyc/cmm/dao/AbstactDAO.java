...
import com.nyc.cmm.util.AbstractMapper;

public class AbstactDAO extends AbstractMapper{
	
	private static final Logger logger = LoggerFactory.getLogger(AbstactDAO.class);
